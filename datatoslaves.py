...
for x in range(index,num_divideddata_files):
        ...
        commandslave_4 = 'dir /B "C:\\smart-watch\\dividedfiles\\" | find /c /v ""'
        ...
        command2 = 'dir /B "C:\\smart-watch\\dividedfiles\\" | find /c /v ""'
        ...
        windowsslave_4result = open('C:\\smartwatch\\popupresults\\windowsslave4.txt', 'r')
        slave4_result = int(windowsslave_4result.readline())

        windowsslave_3result = open('C:\\smartwatch\\popupresults\\windowsslave3.txt', 'r')
